Feature: Furniture Shop left top corner Icon Smoke Tests
  ...
  @E2E @SmokeTest
  Scenario: Click on left top corner Icon from http://projectfurnitureshopmd.000webhostapp.com/krzesla_kuchnia.php site
    Given Navigate to Furniture Shop site "http://projectfurnitureshopmd.000webhostapp.com/krzesla_kuchnia.php"
    When Click on left top corner Icon
    And Wait 2000 milliseconds
    Then Url is "http://projectfurnitureshopmd.000webhostapp.com/index.php"