Feature: Furniture Shop Nav Bar Smoke Tests
  ...
  Scenario: Select bathroom mirrors from navigation bar
    When Click "Łazienka" button from navigation bar
    And Select "Lustra" from dropdown from "Łazienka" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select bathroom sinks from navigation bar
    When Click "Łazienka" button from navigation bar
    And Select "Umywalki" from dropdown from "Łazienka" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select bathroom wardrobes from navigation bar
    When Click "Łazienka" button from navigation bar
    And Select "Szafki" from dropdown from "Łazienka" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select bathroom accessories from navigation bar
    When Click "Łazienka" button from navigation bar
    And Select "Akcesoria Łazienkowe" from dropdown from "Łazienka" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select living room tables from navigation bar
    ...
    When Wait 2000 milliseconds
    And Select "Stoły" from dropdown from "Salon" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select living room corners from navigation bar
    When Click "Salon" button from navigation bar
    And Select "Narożniki" from dropdown from "Salon" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select living room chairs from navigation bar
    When Click "Salon" button from navigation bar
    And Select "Krzesła" from dropdown from "Salon" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select dining room chairs from navigation bar
    When Click "Jadalnia" button from navigation bar
    And Select "Krzesła" from dropdown from "Jadalnia" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select dining room tables from navigation bar
    When Click "Jadalnia" button from navigation bar
    And Select "Stoły" from dropdown from "Jadalnia" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select dining room chests of drawers from navigation bar
    When Click "Jadalnia" button from navigation bar
    And Select "Komody" from dropdown from "Jadalnia" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select dining room glass-case from navigation bar
    When Click "Jadalnia" button from navigation bar
    And Select "Witryny" from dropdown from "Jadalnia" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select bedroom beds from navigation bar
    When Click "Sypialnia" button from navigation bar
    And Select "Łóżka" from dropdown from "Sypialnia" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select bedroom wardrobes from navigation bar
    When Click "Sypialnia" button from navigation bar
    And Select "Szafy" from dropdown from "Sypialnia" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select bedroom mattress from navigation bar
    When Click "Sypialnia" button from navigation bar
    And Select "Materace" from dropdown from "Sypialnia" navigation bar button
    When Wait 2000 milliseconds
  ...
  Scenario: Select bedroom mirrors from navigation bar
    When Click "Sypialnia" button from navigation bar
    And Select "Lustra" from dropdown from "Sypialnia" navigation bar button
    When Wait 2000 milliseconds
